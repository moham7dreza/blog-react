            ...
            <div className="w-full pt-10 px-4 sm:px-6 md:px-8 lg:ps-72">
                ...
                <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                    ...
                    <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                        ...
                        <p className="mt-1 text-gray-600 dark:text-gray-400">Stay in the know with insights from
                            industry experts.</p>
                    </div>
                    {/* <!-- End Title --> */}
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {/* !-- Card --> */}
                        <a className="group dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                           href="#">
                            <div className="relative pt-[50%] sm:pt-[70%] rounded-xl overflow-hidden">
                                ...
                                <span
                                    className="absolute top-0 end-0 rounded-se-xl rounded-es-xl text-xs font-medium bg-gray-800 text-white py-1.5 px-3 dark:bg-gray-900">
          Sponsored
        </span>
                            </div>
                            ...
                            <div className="mt-7">
                                ...
                                <p className="mt-3 text-gray-800 dark:text-gray-200">
                                    Produce professional, reliable streams easily leveraging Prelines innovative
                                    broadcast studio
                                </p>
                        ...
                        {/*        <h3 className="text-xl text-white/[.9] group-hover:text-white"><span*/}
                        {/*            className="font-bold">Preline</span> Press publishes books about economic and*/}
                        {/*            technological advancement.</h3>*/}
                        {/*    </div>*/}
                        {/*    <div className="pt-0 p-4 md:p-6">*/}
                        {/*        <div*/}
                        {/*            className="inline-flex items-center gap-2 text-sm font-medium text-white group-hover:text-white/[.7]">*/}
                        {/*            Visit the site*/}
                        {/*            <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"*/}
                        {/*                 height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"*/}
                        {/*                 strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">*/}
